...
import cz.cuni.mff.d3s.demo.MaxParkingTimeCollector;
				...
				public void set(List<Id> value) {
					...
					if (value == null || value.isEmpty()) {
						...
						if (!parkedVehicles.contains(requesterId) && parkedVehicles.size() == 0) {
							MaxParkingTimeCollector.getInstance().register(requesterId.toString(), ProcessContext.getTimeProvider().getCurrentMilliseconds());
